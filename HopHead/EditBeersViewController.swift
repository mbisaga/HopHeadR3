...
class EditBeersViewController: UIViewController {
    
    //get BeerName that is sent from table view controller
    ...
    @IBOutlet weak var style_txt: UITextField!
    
    
    @IBOutlet weak var beerName_text: UITextField!
    
    
    @IBOutlet weak var breweryName_txt: UITextField!
    
    
    @IBOutlet weak var breweryLocation_txt: UITextField!
    ...
    @IBAction func fav_switch(_ sender: UISwitch) {
